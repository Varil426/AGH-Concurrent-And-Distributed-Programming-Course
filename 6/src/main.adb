...
procedure Main is
   ...
   -- Zadanie mozna bylo rowniez wykonac korzystajac z czasu systemowego, zapamietujace czasu wywolania zerowania, a nastepnie liczac roznice, ale podejrzewam, ze nie o to chodzilo
   -- Metoda ponizej pokazane nie jest doskonala, widac drobne roznice z delay w main, powstale w wyniku wykonywania Zeruj lub Zegar, ktore resetuja delay pod nimi
